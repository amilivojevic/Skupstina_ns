...
(function() {
    angular.module("skupstinaNS").controller("ExportXHTMLController", exportXHTMLController);

    function exportXHTMLController($http, $window, $scope, LoginFactory, $state, $sce) {
        var vm = this;
