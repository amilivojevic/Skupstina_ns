...
@RestController
@RequestMapping("/api/users/predsednik")
public class PredsednikController {
    ...
    public ResponseEntity modifyUser(@RequestBody RegisterSDTO changedUserDTO, @RequestHeader("X-Auth-Token") String token) {
        ...
        korisnik.setAuthority(authorityService.findByName(("ROLE_PREDSEDNIK")));
        TipKorisnika tipKorisnika = TipKorisnika.PREDSEDNIK;
